...
*****************************************************************/
void dma1_stream6_init(uint32_t source, uint32_t destination,
uint32_t lenght)
{
    /*Enable clock access to DMA*/
    RCC->AHB1ENR |= RCC_AHB1ENR_DMA1EN;
    /*Disable DMA1 stream6 (DMA_SxCR)*/
    ...
    /*Clear all interrupt flags of stream*/
    DMA1->HIFCR |= DMA_HIFCR_CFEIF6;
    DMA1->HIFCR |= DMA_HIFCR_CDMEIF6;
    DMA1->HIFCR |= DMA_HIFCR_CTEIF6;
    DMA1->HIFCR |= DMA_HIFCR_CHTIF6;
    DMA1->HIFCR |= DMA_HIFCR_CTCIF6;
    /*Set the destination buffer (DMA_SxPAR)*/
    DMA1_Stream6->PAR = destination;
    /*Set the source buffer (DMA_SxM0AR)*/
    DMA1_Stream6->M0AR = source;
    /*Set length (DMA_SxNDTR)*/
    DMA1_Stream6->NDTR = lenght;
    /*Select stream6 channel4 (DMA_SxCR)*/
    DMA1_Stream6->CR |= DMA_SxCR_CHSEL_2;
    /*Enable memory increment (DMA_SxCR)*/
    DMA1_Stream6->CR |= DMA_SxCR_MINC;
    /*Configure transfer direction (Memory to peripheral)*/
    DMA1_Stream6->CR |= DMA_SxCR_DIR_0;
    /*Enable DMA transfer complete interrupt (DMA_SxCR)*/
    DMA1_Stream6->CR |= DMA_SxCR_TCIE;
    /*Enable direct mode and disable FIFO (DMA_SxFCR)*/
    DMA1_Stream6->FCR = 0x00;
    /*Enable DMA1 Stream6 (DMA_SxCR)*/
    DMA1_Stream6->CR |= DMA_SxCR_EN;
